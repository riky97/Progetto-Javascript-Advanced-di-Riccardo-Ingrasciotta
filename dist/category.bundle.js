...
/***/ "./src/js/api/get_category_book.js":
/*!*****************************************!*\
  !*** ./src/js/api/get_category_book.js ***!
  \*****************************************/
...
/* harmony export */   "default": () => (/* binding */ getCategoryBook)
/* harmony export */ });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);

async function getCategoryBook() {
  ...
  let response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(`https://openlibrary.org/subjects/${category}.json`).then(function (res) {
    // handle success
  ...
  if (response.length === 0 || response == undefined) {
    ...
    sessionStorage.setItem("collectionBook", JSON.stringify(arrayBook)); //console.log(JSON.parse(sessionStorage.getItem("collectionBook")));
...
"use strict";
/*!*******************************************!*\
  !*** ./src/js/api/api_search_category.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _get_category_book__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./get_category_book */ "./src/js/api/get_category_book.js");
...
form.addEventListener("submit", event => {
  ...
  async function category() {
    let res = await (0,_get_category_book__WEBPACK_IMPORTED_MODULE_0__["default"])();
